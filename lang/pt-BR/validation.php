...
return [
    ...
    */
    ...
    // MENSAGENS MAUNAL DE ACORDO COM O NAME DO CAMPO
    'custom' => [

        'password_confirmation' => 'The :attribute confirmation does not mddfgfgatch.',

        'name' => [
            'required' => 'Digite seu nome',
            'min' => 'O nome deve possuir pelo menos 3 caracteres'
        ],
        'email' => [
            'required' => 'Digite seu email',
            'unique' => 'Este email já está cadastrado',
            'min' => 'O email deve possuir pelo menos 6 caracteres',
        ],
        'password' => [ 
            'required' => 'Digite sua senha', 
            'min' => 'A senha deve possuir pelo menos 8 caracteres',
            'max' => 'A senha deve possuir no maximo 15 caracteres',
        ],
